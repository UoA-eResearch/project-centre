...
@RestController
@Api(tags={"Person"}, description="Operations on persons")
...
public class PersonController extends ControllerExceptionHandler {
  ...
  @ApiOperation(value = "get existing person")
  ...
  @ApiOperation(value = "get all affiliations of a person")
  ...
  @ApiOperation(value = "add affiliation to person")
  ...
  @ApiOperation(value = "get existing person affiliation")
  ...
  @ApiOperation(value = "remove existing person affiliation")
  ...
  @ApiOperation(value = "patch existing person affiliation. same input fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing person affiliation")
  ...
  public @ResponseBody ResponseEntity<Void> affiliationPut(@PathVariable Integer personId,
    ...
    return affiliationController.put(new MapUtil("id", id).add("personId", personId).create(), personAffiliationUpdate);
  }

  //// person property
  
  @ApiOperation(value = "get all properties of a person")
  ...
  @ApiOperation(value = "add property to person")
  ...
  @ApiOperation(value = "get existing person property")
  ...
  @ApiOperation(value = "remove existing person property")
  ...
  @ApiOperation(value = "patch existing person property. same input fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing person property")
  ...
  public @ResponseBody ResponseEntity<Void> propertyPut(@PathVariable Integer personId,
    ...
    return propertyController.put(new MapUtil("id", id).add("personId", personId).create(), propertyUpdate);
  }

  //// helper methods
  
  @ApiOperation(value = "get all projects of a person")
