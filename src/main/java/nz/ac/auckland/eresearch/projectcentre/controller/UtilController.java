...
public class UtilController extends ControllerExceptionHandler {
  ...
  @ApiOperation(value = "get all divisional role options", nickname="controllers.util.get_divisional_role_options")
  ...
  @ApiOperation(value = "create new divisional role option", nickname="controllers.util.create_divisional_role_option")
  ...
  @ApiOperation(value = "get existing divisional role option", nickname="controllers.util.get_divisional_role_option")
  ...
  @ApiOperation(value = "remove existing divisional role option", nickname="controllers.util.delete_divisional_role_option")
  ...
  @ApiOperation(value = "update existing divisional role option", nickname="controllers.util.update_divisional_role_option")
  ...
  @ApiOperation(value = "get all person status options", nickname="controllers.util.get_person_status_options")
  ...
  @ApiOperation(value = "create new person status option", nickname="controllers.util.create_person_status_option")
  ...
  @ApiOperation(value = "get existing person status option", nickname="controllers.util.get_person_status_option")
  ...
  @ApiOperation(value = "remove existing person status option", nickname="controllers.util.delete_person_status_option")
  ...
  @ApiOperation(value = "update existing person status option", nickname="controllers.util.update_person_status_option")
  ...
  @ApiOperation(value = "get all divisions", nickname="controllers.util.get_divisions")
  ...
  @ApiOperation(value = "create new division", nickname="controllers.util.create_division")
  ...
  @ApiOperation(value = "get existing division", nickname="controllers.util.get_division")
  ...
  @ApiOperation(value = "remove existing division", nickname="controllers.util.delete_division")
  ...
  @ApiOperation(value = "patch existing division. same input fields like in PUT can be updated", nickname="controllers.util.patch_division")
  ...
  @ApiOperation(value = "update existing division", nickname="controllers.util.update_division")
  ...
  @ApiOperation(value = "get all facilities", nickname="controllers.util.get_facilities")
  ...
  @ApiOperation(value = "create new facility", nickname="controllers.util.create_facility")
  ...
  @ApiOperation(value = "get existing facility", nickname="controllers.util.get_facility")
  ...
  @ApiOperation(value = "remove existing facility", nickname="controllers.util.delete_facility")
  ...
  @ApiOperation(value = "update existing facility", nickname="controllers.util.update_facility")
  ...
  @ApiOperation(value = "get all project status options", nickname="controllers.util.get_project_status_options")
  ...
  @ApiOperation(value = "create new project status option", nickname="controllers.util.create_project_status_option")
  ...
  @ApiOperation(value = "get existing project status option", nickname="controllers.util.get_project_status_option")
  ...
  @ApiOperation(value = "remove existing project status option", nickname="controllers.util.delete_project_status_option")
  ...
  @ApiOperation(value = "update existing project status option", nickname="controllers.util.update_project_status_option")
  ...
  @ApiOperation(value = "get all project action type options", nickname="controllers.util.get_project_action_type_options")
  ...
  @ApiOperation(value = "create new project action type option", nickname="controllers.util.create_project_action_type_option")
  ...
  @ApiOperation(value = "get existing project action type option", nickname="controllers.util.get_project_action_type_option")
  ...
  @ApiOperation(value = "remove existing project action type option", nickname="controllers.util.delete_project_action_type_option")
  ...
  @ApiOperation(value = "update existing project action type option", nickname="controllers.util.update_project_action_type_option")
  ...
  @ApiOperation(value = "get all project type options", nickname="controllers.util.get_project_type_options")
  ...
  @ApiOperation(value = "create new project type option", nickname="controllers.util.create_project_type_option")
  ...
  @ApiOperation(value = "get existing project type option", nickname="controllers.util.get_project_type_option")
  ...
  @ApiOperation(value = "remove existing project type option", nickname="controllers.util.delete_project_type_option")
  ...
  @ApiOperation(value = "update existing project type option", nickname="controllers.util.update_project_type_option")
  ...
  @ApiOperation(value = "get all research output type options", nickname="controllers.util.get_research_output_type_options")
  ...
  @ApiOperation(value = "create new research output type option", nickname="controllers.util.create_research_output_type_option")
  ...
  @ApiOperation(value = "get existing research output type option", nickname="controllers.util.get_research_output_type_option")
  ...
  @ApiOperation(value = "remove existing research output type option", nickname="controllers.util.delete_research_output_type_option")
  ...
  @ApiOperation(value = "update existing research output type option", nickname="controllers.util.update_research_output_type_option")
  ...
  @ApiOperation(value = "get all person role options", nickname="controllers.util.get_person_role_options")
  ...
  @ApiOperation(value = "create new person role option", nickname="controllers.util.create_person_role_option")
  ...
  @ApiOperation(value = "get existing person role option", nickname="controllers.util.get_person_role_option")
  ...
  @ApiOperation(value = "remove existing person role option", nickname="controllers.util.delete_person_role_option")
  ...
  @ApiOperation(value = "update existing person role option", nickname="controllers.util.update_person_role_option")
  ...
  @ApiOperation(value = "get all service instance status options", nickname="controllers.util.get_service_instance_status_options")
  ...
  @ApiOperation(value = "create new service instance status option", nickname="controllers.util.create_service_instance_status_option")
  ...
  @ApiOperation(value = "get existing service instance status option", nickname="controllers.util.get_service_instance_status_option")
  ...
  @ApiOperation(value = "remove existing service instance status option", nickname="controllers.util.delete_service_instance_status_option")
  ...
  @ApiOperation(value = "update existing service instance status option", nickname="controllers.util.update_service_instance_status_option")
