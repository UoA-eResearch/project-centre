...
@RestController
@Api(tags={"Project"}, description="Operations on projects")
...
public class ProjectController extends ControllerExceptionHandler {
  ...
  @ApiOperation(value = "get list of projects")
  ...
  @ApiOperation(value = "get existing project")
  ...
  @ApiOperation(value = "get existing project by code")
  ...
  @ApiOperation(value = "patch existing project. same fields like in PUT can be updated")
  ...
  @ApiOperation(value = "delete existing project")
  ...
  @ApiOperation(value = "get list of project actions")
  ...
  @ApiOperation(value = "create new project action")
  ...
  @ApiOperation(value = "get existing project action")
  ...
  @ApiOperation(value = "patch existing project action. same fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing project action")
  ...
  @ApiOperation(value = "delete existing project action")
  ...
  @ApiOperation(value = "get list of research outputs")
  ...
  @ApiOperation(value = "create new research output")
  ...
  @ApiOperation(value = "get existing research output")
  ...
  @ApiOperation(value = "patch existing research output. same fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing research output")
  ...
  @ApiOperation(value = "delete existing research output")
  ...
  @ApiOperation(value = "get all members of project")
  ...
  @ApiOperation(value = "add member to project")
  ...
  @ApiOperation(value = "get existing project member")
  ...
  @ApiOperation(value = "remove existing project member")
  ...
  @ApiOperation(value = "patch existing project member. same input fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing project member")
  ...
  @ApiOperation(value = "get all external references of project")
  ...
  @ApiOperation(value = "add external reference to project")
  ...
  @ApiOperation(value = "get existing external reference")
  ...
  @ApiOperation(value = "remove existing external reference")
  ...
  @ApiOperation(value = "patch existing external reference. same input fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing external reference")
  ...
  @ApiOperation(value = "get all properties of a project")
  ...
  @ApiOperation(value = "add property to project")
  ...
  @ApiOperation(value = "get existing project property")
  ...
  @ApiOperation(value = "remove existing project property")
  ...
  @ApiOperation(value = "patch existing project property. same input fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing project property")
  ...
  @ApiOperation(value = "add division to project")
  ...
  @ApiOperation(value = "remove existing project division")
  ...
  @ApiOperation(value = "get list of service instances")
  ...
  @ApiOperation(value = "create new service instance")
  ...
  @ApiOperation(value = "get existing service instance")
  ...
  @ApiOperation(value = "patch existing service instance. same fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing service instance")
  ...
  @ApiOperation(value = "delete existing service instance")
  ...
  @ApiOperation(value = "get a wrapper object of a project")
  ...
  @ApiOperation(value = "get a wrapper object of a project by code")
