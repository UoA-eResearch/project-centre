...
@Entity
@Table(name = "projectactiontype")
public class ProjectActionType implements Serializable, HasId, IdNameType {
  ...
  public ProjectActionType() {
  }

  public ProjectActionType(String name) {
    super();
    this.name = name;
  }
