...
public class ServiceController extends ControllerExceptionHandler {
  ...
  @ApiOperation(value = "get list of services", nickname="backend.service.get_services")
...
//  @ApiOperation(value = "create new service", nickname="backend.service.create_services")
...
//  }
//
//  @ApiOperation(value = "get existing service", nickname="backend.service.get_service")
...
//  }
//
//  @ApiOperation(value = "patch existing service. same fields like in PUT can be updated", nickname="backend.service.patch_service")
...
//  }
//
//  @ApiOperation(value = "update existing service", nickname="backend.service.update_service")
...
//  }
//
//  @ApiOperation(value = "delete existing service", nickname="backend.service.delete_service")
...
//  @ApiOperation(value = "get list of service owners", nickname="backend.service.get_service_owners")
...
//  }
//
//  @ApiOperation(value = "create new service owner", nickname="backend.service.create_service_owner")
...
//  }
//  
//  @ApiOperation(value = "get existing service owner", nickname="backend.service.get_service_owner")
...
//  }
//
//  @ApiOperation(value = "patch existing service owner. same fields like in PUT can be updated", nickname="backend.service.update_service_owner")
...
//  }
//
//  @ApiOperation(value = "update existing service owner", nickname="backend.service.update_service_owner")
...
//  }
//
//  @ApiOperation(value = "delete existing service owner", nickname="backend.service.delete_service_owner")
...
//  }
  ...
  @ApiOperation(value = "get list of service schemas", nickname="backend.service.get_service_schemas")
  ...
  @ApiOperation(value = "create new service schema", nickname="backend.service.create_service_schema")
  ...
  @ApiOperation(value = "get existing service schema", nickname="backend.service.get_service_schema")
  ...
  @ApiOperation(value = "patch existing service schema. same fields like in PUT can be updated", nickname="backend.service.patch_service_schema")
  ...
  @ApiOperation(value = "update existing service schema", nickname="backend.service.update_service_schema")
  ...
  @ApiOperation(value = "delete existing service schema", nickname="backend.service.delete_service_schema")
