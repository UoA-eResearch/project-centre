...
@RestController
@Api(tags={"Service"}, description="Operations on services")
...
public class ServiceController extends ControllerExceptionHandler {
  ...
  @ApiOperation(value = "get existing service")
  ...
  @ApiOperation(value = "patch existing service. same fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing service")
  ...
  @ApiOperation(value = "delete existing service")
  ...
  @ApiOperation(value = "get list of service owners")
  ...
  @ApiOperation(value = "create new service owner")
  ...
  @ApiOperation(value = "get existing service owner")
  ...
  @ApiOperation(value = "patch existing service owner. same fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing service owner")
  ...
  @ApiOperation(value = "delete existing service owner")
  ...
  @ApiOperation(value = "get list of service schemas")
  ...
  @ApiOperation(value = "create new service schema")
  ...
  @ApiOperation(value = "get existing service schema")
  ...
  @ApiOperation(value = "patch existing service schema. same fields like in PUT can be updated")
  ...
  @ApiOperation(value = "update existing service schema")
  ...
  @ApiOperation(value = "delete existing service schema")
