...
public class ServiceController extends ControllerExceptionHandler {
  ...
  @ApiOperation(value = "get list of services", nickname="controllers.service.get_services")
...
//  @ApiOperation(value = "create new service", nickname="controllers.service.create_services")
...
//  }
//
//  @ApiOperation(value = "get existing service", nickname="controllers.service.get_service")
//  @RequestMapping(value = "/{serviceId}", method = RequestMethod.GET)
//  public @ResponseBody ResponseEntity<ServiceGet> serviceGet(@PathVariable Integer serviceId) throws Exception {
//    return serviceController.get(new MapUtil("id", serviceId).create());
//  }
//
//  @ApiOperation(value = "patch existing service. same fields like in PUT can be updated", nickname="controllers.service.patch_service")
//  @RequestMapping(value = "/{serviceId}", method = RequestMethod.PATCH)
//  public @ResponseBody ResponseEntity<Void> servicePatch(@PathVariable Integer serviceId,
//      @RequestBody ServicePut params) throws Exception {
//    return serviceController.patch(new MapUtil("id", serviceId).create(), params);
//  }
//
//  @ApiOperation(value = "update existing service", nickname="controllers.service.update_service")
//  @RequestMapping(value = "/{serviceId}", method = RequestMethod.PUT)
//  public @ResponseBody ResponseEntity<Void> servicePut(@PathVariable Integer serviceId,
//      @RequestBody ServicePut serviceUpdate) throws Exception {
//    return serviceController.put(new MapUtil("id", serviceId).create(), serviceUpdate);
//  }
//
//  @ApiOperation(value = "delete existing service", nickname="controllers.service.delete_service")
//  @RequestMapping(value = "/{serviceId}", method = RequestMethod.DELETE)
//  public @ResponseBody ResponseEntity<Void> serviceDelete(@PathVariable Integer serviceId) throws Exception {
//    return serviceController.delete(new MapUtil("id", serviceId).create());
//  }
  
  //// service owner
  
//  @ApiOperation(value = "get list of service owners", nickname="controllers.service.get_service_owners")
...
//  }
//
//  @ApiOperation(value = "create new service owner", nickname="controllers.service.create_service_owner")
...
//  }
//  
//  @ApiOperation(value = "get existing service owner", nickname="controllers.service.get_service_owner")
//  @RequestMapping(value = "/owner/{ownerId}", method = RequestMethod.GET)
//  public @ResponseBody ResponseEntity<ServiceOwnerGet> serviceOwnerGet(@PathVariable Integer ownerId) throws Exception {
//    return serviceOwnerController.get(new MapUtil("id", ownerId).create());
//  }
//
//  @ApiOperation(value = "patch existing service owner. same fields like in PUT can be updated", nickname="controllers.service.update_service_owner")
//  @RequestMapping(value = "/owner/{ownerId}", method = RequestMethod.PATCH)
//  public @ResponseBody ResponseEntity<Void> serviceOwnerPatch(@PathVariable Integer ownerId,
//      @RequestBody ServiceOwnerPut params) throws Exception {
//    return serviceOwnerController.patch(new MapUtil("id", ownerId).create(), params);
//  }
//
//  @ApiOperation(value = "update existing service owner", nickname="controllers.service.update_service_owner")
//  @RequestMapping(value = "/owner/{ownerId}", method = RequestMethod.PUT)
//  public @ResponseBody ResponseEntity<Void> serviceOwnerPut(@PathVariable Integer ownerId,
//      @RequestBody ServiceOwnerPut serviceOwnerUpdate) throws Exception {
//    return serviceOwnerController.put(new MapUtil("id", ownerId).create(), serviceOwnerUpdate);
//  }
//
//  @ApiOperation(value = "delete existing service owner", nickname="controllers.service.delete_service_owner")
//  @RequestMapping(value = "/owner/{ownerId}", method = RequestMethod.DELETE)
//  public @ResponseBody ResponseEntity<Void> serviceOwnerDelete(@PathVariable Integer ownerId) throws Exception {
//    return serviceOwnerController.delete(new MapUtil("id", ownerId).create());
//  }
  
  //// service schema
  
  @ApiOperation(value = "get list of service schemas", nickname="controllers.service.get_service_schemas")
  ...
  @ApiOperation(value = "create new service schema", nickname="controllers.service.create_service_schema")
  ...
  @ApiOperation(value = "get existing service schema", nickname="controllers.service.get_service_schema")
  ...
  @ApiOperation(value = "patch existing service schema. same fields like in PUT can be updated", nickname="controllers.service.patch_service_schema")
  ...
  @ApiOperation(value = "update existing service schema", nickname="controllers.service.update_service_schema")
  ...
  @ApiOperation(value = "delete existing service schema", nickname="controllers.service.delete_service_schema")
